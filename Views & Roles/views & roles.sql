...
select a.name as instructor_name, count(s_id) as student_count
...
grant select on student to head_of_department;
grant select on course to head_of_department;
grant insert on instructor to head_of_department;
select * from student;
select * from course;
...
create user 'teacher'@'localhost' identified by '12345';
grant course_teacher to 'teacher'@'localhost';

create user 'hod'@'localhost' identified by '12345';
grant head_of_department to 'hod'@'localhost';
